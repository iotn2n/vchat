...
public class ParseManager {
    ...
    private static final String ParseAppID = "emqchat";
	private static final String ParseClientKey = "emqchat";

	private static final String CONFIG_TABLE_NAME = "emquser";
	...
	public void onInit(Context context) {
		...
		Parse.initialize(new Parse.Configuration.Builder(this.appContext)
				.clientKey(ParseClientKey)
		        .applicationId(ParseAppID)
		        .server("http://121.201.29.116/parse/")
		        .build());
		ParseUser.enableAutomaticUser();
		EMLog.i(TAG, "onInit ParseManager" );
	}

	public boolean updateParseNickName(final String nickname) {
		String username = EMClient.getInstance().getCurrentUserName();
			...
			public void done(List<ParseObject> arg0, ParseException arg1) {
				if (arg0 != null) {
					...
					for (ParseObject pObject : arg0) {
						...
						user.setEid(pObject.getObjectId());
	...
	public void asyncGetCurrentUserInfo(final EMValueCallBack<EaseUser> callback){
		final String username = EMClient.getInstance().getCurrentUserName();
