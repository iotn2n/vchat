...
public class DemoHelper {
	...
	private EMOptions initChatOptions(){
        Log.d(TAG, "init Emqchat Options");
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onApplicationAccept(String groupId, String groupName, String accepter) {
            ...
            msg.setTo(groupId);
            msg.setMsgId(EMMessageUtils.getUniqueMessageId());
            ...
            EMLog.i(TAG,"onApplicationAccept groupId " + groupId);
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_GROUP_CHANAGED));
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        @Override
        public void onContactInvited(String username, String userId, String reason) {
            ...
            msg.setTime(System.currentTimeMillis());
            msg.setReason(reason);
            EMLog.i(TAG, username + " apply to be your friend,reason: " + reason);
        ...
        public void onContactAgreed(String username) {
            ...
            notifyNewInviteMessage(msg);
            EMLog.i(TAG,"onContactAgreed " +  username);
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_CONTACT_CHANAGED));
        }
    ...
    protected void registerMessageListener() {
    	messageListener = new EMMessageListener() {
			...
			public void onMessageReadAckReceived(List<EMMessage> messages) {
                EMLog.d(TAG, String.format("onMessageReadAckReceived ", messages.get(0).toString()));
			}
			
			@Override
			public void onMessageDeliveryAckReceived(List<EMMessage> messages) {
                EMLog.d(TAG, String.format("onMessageDeliveryAckReceived ", messages.get(0).toString()));
			}
			
			@Override
			public void onMessageChanged(EMMessage message, Object change) {
                EMLog.d(TAG, String.format("onMessageChanged ", message.toString()));
			}
		};
