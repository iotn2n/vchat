...
public class DemoDBManager {
    ...
    synchronized public void saveContactList(List<EaseUser> contactList) {
        ...
        if (db.isOpen()) {
            ...
            for (EaseUser user : contactList) {
                ...
                if(user.getEid() != null)
                    values.put(UserDao.COLUMN_USER_ID, user.getEid());
    ...
    public synchronized Integer saveMessage(InviteMessage message){
        ...
        if(db.isOpen()){
            ...
            values.put(InviteMessgeDao.COLUMN_NAME_USERID, message.getUserid());
    ...
    synchronized public List<InviteMessage> getMessagesList(){
        ...
        if(db.isOpen()){
            ...
            while(cursor.moveToNext()){
                ...
                String userid = cursor.getString(cursor.getColumnIndex(InviteMessgeDao.COLUMN_NAME_USERID));
