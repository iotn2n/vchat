...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        ...
        EMLog.i(TAG, " EaseChatRow message " + this.message.toString());
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            ...
            EMContact contact = EMClient.getInstance().contactManager().getContactByUserId(message.getFrom());
            EaseUserUtils.setUserAvatar(context, contact.getUsername(), userAvatarView);
            EaseUserUtils.setUserNick(contact.getNick(), usernickView);
        }
        ...
        if(messageSendCallback == null){
            messageSendCallback = new EMCallBack() {
                ...
                public void onSuccess() {
                    EMLog.i(TAG," setMessageSendCallback onSuccess" );
                    updateView();
                }
