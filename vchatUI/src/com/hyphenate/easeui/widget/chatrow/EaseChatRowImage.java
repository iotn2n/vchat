...
public class EaseChatRowImage extends EaseChatRowFile{
    protected static final String TAG = "EaseChatRowImage";
    protected ImageView imageView;
    private EMImageMessageBody imgBody;

    public EaseChatRowImage(Context context, EMMessage message, int position, BaseAdapter adapter) {
        super(context, message, position, adapter);
        EMLog.i(TAG, " EaseChatRowImage message " +  message.toString());
    }
    ...
    protected void onSetUpView() {
        ...
        if (message.direct() == EMMessage.Direct.RECEIVE) {
            if (imgBody.thumbnailDownloadStatus() == EMFileMessageBody.EMDownloadStatus.DOWNLOADING ||
                ...
                EMLog.i(TAG, " onSetUpView  thumbPath " +  thumbPath + " localUrl " + imgBody.getLocalUrl() + " message " + message.toString());
    ...
    private boolean showImageView(final String thumbernailPath, final ImageView iv, final String localFullSizePath,final EMMessage message) {
        ...
        EMLog.i(TAG, " showImageView thumbernailPath " + thumbernailPath);
        if (bitmap != null) {
