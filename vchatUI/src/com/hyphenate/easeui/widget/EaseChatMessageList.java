...
public class EaseChatMessageList extends RelativeLayout{
     ...
     */
    public void init(String toChatUserid, int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        this.chatType = chatType;
        this.toChatUserid = toChatUserid;

        EMLog.i(TAG, " init toChatUserid " + toChatUserid);
        ...
        messageAdapter = new EaseMessageAdapter(context, toChatUserid, chatType, listView);
     ...
     * refresh
     */
      public void refreshByMsgId(String  msgId, EMMessage.Status msgStatus){
        if (messageAdapter != null) {
            for(int i = messageAdapter.getCount()-1; i >= 0; i--) {
                 if(messageAdapter.getItem(i).getMsgId().equals(msgId)) {
                     messageAdapter.getItem(i).setStatus(msgStatus);
                     EMLog.i(TAG, "refreshByMsgId msgId " + msgId);
